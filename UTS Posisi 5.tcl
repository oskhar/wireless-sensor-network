...
# Membuat node dalam dua menara (twin towers)
# Menara kiri
set n0 [$ns node]  ;# Menara kiri, lantai 1
$n0 set X_ 150.0
$n0 set Y_ 100.0

set n1 [$ns node]  ;# Menara kiri, lantai 2
$n1 set X_ 150.0
$n1 set Y_ 150.0

set n2 [$ns node]  ;# Menara kiri, lantai 3
$n2 set X_ 150.0
$n2 set Y_ 200.0

set n3 [$ns node]  ;# Menara kiri, lantai 4
$n3 set X_ 150.0
$n3 set Y_ 250.0

set n4 [$ns node]  ;# Menara kiri, lantai 5
$n4 set X_ 150.0
$n4 set Y_ 300.0

# Menara kanan
set n5 [$ns node]  ;# Menara kanan, lantai 1
$n5 set X_ 300.0
$n5 set Y_ 100.0

set n6 [$ns node]  ;# Menara kanan, lantai 2
$n6 set X_ 300.0
$n6 set Y_ 150.0

set n7 [$ns node]  ;# Menara kanan, lantai 3
$n7 set X_ 300.0
$n7 set Y_ 200.0

set n8 [$ns node]  ;# Menara kanan, lantai 4
$n8 set X_ 300.0
$n8 set Y_ 250.0

set n9 [$ns node]  ;# Menara kanan, lantai 5
$n9 set X_ 300.0
$n9 set Y_ 300.0

# Menghubungkan node dalam tiap menara
...
# Menambahkan link horizontal antara kedua menara
...
# Membuat node dalam pola bintang
# Node pusat
set n0 [$ns node]
$n0 set X_ 250.0
$n0 set Y_ 250.0

# Node di ujung bintang
set n1 [$ns node]
$n1 set X_ 250.0
$n1 set Y_ 350.0
...
# Menghubungkan node pusat ke semua ujung bintang untuk pola simetris
$ns duplex-link $n0 $n1 2Mb 10ms DropTail
...
# Menghubungkan node di ujung-ujung bintang untuk membuat bentuk bintang penuh
$ns duplex-link $n1 $n2 2Mb 10ms DropTail
$ns duplex-link $n2 $n3 2Mb 10ms DropTail
$ns duplex-link $n3 $n4 2Mb 10ms DropTail
...
$ns duplex-link-op $n0 $n9 orient up
