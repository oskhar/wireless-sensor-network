...
# Membuat 10 node dan menetapkan posisi baru (berbentuk segitiga atau piramida)
set n0 [$ns node]
$n0 set X_ 100.0
$n0 set Y_ 50.0
...
# Menghubungkan node dengan link duplex dan orientasi
...
$ns duplex-link-op $n0 $n3 orient up-right
$ns duplex-link-op $n1 $n4 orient up-right
$ns duplex-link-op $n2 $n5 orient up
$ns duplex-link-op $n3 $n4 orient right
$ns duplex-link-op $n4 $n5 orient right
$ns duplex-link-op $n3 $n6 orient up
$ns duplex-link-op $n4 $n7 orient up-right
$ns duplex-link-op $n5 $n8 orient up
$ns duplex-link-op $n6 $n7 orient right
$ns duplex-link-op $n7 $n8 orient right
$ns duplex-link-op $n7 $n9 orient up
$ns duplex-link-op $n8 $n9 orient up-left
